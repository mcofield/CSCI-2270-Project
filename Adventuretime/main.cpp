...
void help(){
	...
	cout<< "Depending on the difficulty you chose your path home may be more rigorous. "<<endl;
...
int main(){
	...
	cout<<"Thank you for playing! If you'd like to see how you faired here are some options:"<<endl;
